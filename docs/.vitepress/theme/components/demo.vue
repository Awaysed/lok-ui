            ...
            <transition name="arrow-slide">
                <i
                    :class="[
                        'demo-control-icon',
                        isExpanded
                            ? 'demo-control-icon_up'
                            : 'demo-control-icon_down',
                    ]"
                ></i>
            </transition>
...
// @ts-ignore
const tempModules = import.meta.glob('../../examples/**/**/*.vue')
const formatPathDemos = (modules) => {
    const demos = {}
...
const modules = formatPathDemos(tempModules)
